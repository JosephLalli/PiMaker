...
def generate_coding_filters(sample_consensus_seqs,
    ...
    if idx_of_var_sites_in_transcript is not None:
        ...
        tmp_mask[:, idx_of_var_sites_in_transcript, :] = False
        ...
        nonSynonFilter = nonSynonFilter[:, idx_of_var_sites_in_transcript, :]
        synonFilter = synonFilter[:, idx_of_var_sites_in_transcript, :]
        nonSynonSites = nonSynonSites[:, idx_of_var_sites_in_transcript, :]
        synonSites = synonSites[:, idx_of_var_sites_in_transcript, :]
